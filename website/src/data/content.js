...
export const guideLibrary = [
  {
    ...
    downloadHref: '/downloads/facilitator-guide.md',
  },
  {
    ...
    downloadHref: '/downloads/learner-workbook.md',
  },
  {
    ...
    downloadHref: '/downloads/nonprofit-ai-safety-kit.md',
  },
  {
    ...
    downloadHref: '/downloads/community-ai-readiness-lab-presentation-draft.pptx',
    downloadLabel: 'PowerPoint',
  },
  {
    ...
    downloadHref: '/downloads/model-parameter-explainer.md',
  },
  {
    title: 'Sources and further reading',
    description: 'Current first-party references used for risk, privacy, vendor, and verification guidance.',
    href: '/guides/sources/',
    downloadHref: '/downloads/sources-and-further-reading.md',
  },
]
