      ...
      <div className="shell hero-layout">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <a className="button button--primary" href={contactHref}>Request information</a>
            <a className="text-link" href="/guides/">Use the free guides</a>
          </div>
          <p className="nonprofit-note">A nonprofit community education initiative in development.</p>
        </div>
