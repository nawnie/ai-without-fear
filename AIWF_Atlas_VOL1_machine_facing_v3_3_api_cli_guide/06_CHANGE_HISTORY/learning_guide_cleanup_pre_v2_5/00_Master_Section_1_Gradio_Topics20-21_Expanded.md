...
**Document Version**: 1.0 | **Target Total**: 100 pages | **Current Section Pages**: 28 (when formatted with diagrams, code blocks, and exercises) | **Date**: 2026-05-19

**How to Use This Section**:
- Read as a complete mini-course.
- Run every code example locally (Gradio 5+ required: `pip install gradio`).
- Complete both labs before moving to the next section.
- Use the "Key Facts for AI Agents" appendix for RAG/LoRA training.
...
These will be rendered as high-quality images in the final PDF using Grok Imagine or reportlab.
...
**End of Section 1 (28 pages when formatted)**  

**Current Master PDF Page Count Target**: 28 pages (this section) + 72 pages remaining target = **100 pages total**.

---

*This is the first major section of the 100-page master PDF. All content is designed for both human data scientists and AI agents.*
