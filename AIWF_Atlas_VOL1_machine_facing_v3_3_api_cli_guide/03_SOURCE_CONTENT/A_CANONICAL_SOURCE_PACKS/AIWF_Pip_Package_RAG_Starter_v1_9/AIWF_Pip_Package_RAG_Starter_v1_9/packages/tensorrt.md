...
- **category:** `nvidia_tensorrt_metapackage`
- **AIWF confidence:** source-reviewed for TensorRT/NVIDIA inference stack placement and support-risk classification.

## What it is
NVIDIA TensorRT Python metapackage for high-performance NVIDIA GPU inference from optimized engines.
...
Use only after checking TensorRT support matrix, Python version, CUDA family, driver, and NVIDIA package index requirements. Treat as an inference/runtime stack, not a training package.
...
## Sources
https://docs.nvidia.com/deeplearning/tensorrt/latest/installing-tensorrt/installing.html | https://docs.nvidia.com/deeplearning/tensorrt/latest/getting-started/support-matrix.html | https://pypi.nvidia.com/ | https://pypi.org/project/tensorrt/
