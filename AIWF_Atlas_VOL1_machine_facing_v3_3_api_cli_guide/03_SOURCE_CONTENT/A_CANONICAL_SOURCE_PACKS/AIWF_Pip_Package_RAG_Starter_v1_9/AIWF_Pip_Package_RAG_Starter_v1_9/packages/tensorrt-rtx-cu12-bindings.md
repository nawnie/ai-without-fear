# tensorrt-rtx-cu12-bindings

## Identity
- **pip name:** `tensorrt-rtx-cu12-bindings`
- **import/module clue:** `TensorRT RTX Python bindings`
- **category:** `nvidia_tensorrt_rtx_bindings`
- **AIWF confidence:** source-reviewed for TensorRT/NVIDIA inference stack placement and support-risk classification.

## What it is
CUDA 12-family TensorRT-RTX Python bindings.
...
Pair with matching RTX libs and verify a small ONNX-to-engine workflow rather than relying on import checks.
...
1. `python -m pip show tensorrt-rtx-cu12-bindings`.
