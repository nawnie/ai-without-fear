...
## What it is
CUDA 13-family TensorRT lean runtime package.
...
Newest lean runtime family. Treat as deployment/runtime optimization, not first-line diagnostic install.
...
1. `python -m pip show tensorrt-lean-cu13`.
