...
## Identity
- **pip name:** `llmcompressor`
- **import/module clue:** `llmcompressor`
...
## What it is
Quantization/compression toolkit recommended by vLLM docs for deployment optimization across FP8, INT8, INT4, and related formats.
...
```powershell
python -m pip show llmcompressor
python - <<'PY'
import importlib
mod = 'llmcompressor'
try:
...
## Sources
https://docs.vllm.ai/en/latest/features/quantization/ | https://github.com/vllm-project/llm-compressor
