...
## Identity
- **pip name:** `nvidia-nvtx-cu12`
- **import/module clue:** `nvidia.nvtx`
- **category:** `nvidia_profiling`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
NVTX profiling/instrumentation library for CUDA 12-family stacks.
...
Useful for profiling; not a fix for broken kernels.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-nvtx-cu12`.
