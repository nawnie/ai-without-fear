...
## What it is
Structured generation/constrained decoding backend used around JSON/schema/grammar output enforcement in modern serving stacks.
...
## Sources
https://xgrammar.mlc.ai/ | https://docs.vllm.ai/en/latest/features/structured_outputs/
