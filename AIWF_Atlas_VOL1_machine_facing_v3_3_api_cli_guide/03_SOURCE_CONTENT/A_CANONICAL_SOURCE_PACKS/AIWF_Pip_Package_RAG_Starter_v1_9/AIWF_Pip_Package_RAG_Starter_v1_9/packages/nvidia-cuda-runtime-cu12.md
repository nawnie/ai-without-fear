...
## Identity
- **pip name:** `nvidia-cuda-runtime-cu12`
...
## What it is
CUDA runtime libraries for CUDA 12-family Python environments; runtime only, not a full developer toolkit.
...
Do not assume nvcc exists after installing runtime wheels. Pair with provider/library checks.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-cuda-runtime-cu12`.
