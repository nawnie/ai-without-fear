...
## Identity
- **pip name:** `tensorrt-cu13-libs`
- **import/module clue:** `TensorRT DLL/shared libraries`
...
## What it is
CUDA 13-family TensorRT runtime libraries.
...
PyPI lists source distribution metadata and NVIDIA index entries; verify real library resolution in the final environment, not just package metadata.
...
1. `python -m pip show tensorrt-cu13-libs`.
...
## Sources
https://pypi.org/project/tensorrt-cu13-libs/ | https://pypi.nvidia.com/
