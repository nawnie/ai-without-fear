...
## Identity
- **pip name:** `polygraphy`
- **import/module clue:** `polygraphy`
- **category:** `model_debugging_accuracy_validation`
- **AIWF confidence:** source-reviewed for TensorRT/NVIDIA inference stack placement and support-risk classification.

## What it is
NVIDIA toolkit for running/debugging models across frameworks, including ONNX/TensorRT accuracy comparison and benchmarking workflows.
...
Use for support-grade evidence: compare ONNX Runtime vs TensorRT outputs, inspect tactics, reduce failures, and validate whether optimization changed outputs.
...
1. `python -m pip show polygraphy`.
...
## Windows risk
`medium` — TensorRT workflows are sensitive to Python wheel tags, NVIDIA package index access, DLL loading, CUDA/cuDNN family, and platform support.

## Sources
https://docs.nvidia.com/deeplearning/tensorrt/latest/api/polygraphy-api.html | https://pypi.nvidia.com/
