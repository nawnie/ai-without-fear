...
## What it is
CUDA 12-family TensorRT-RTX package.
...
Use for RTX-oriented runtime workflows when the target docs/workflow explicitly call for TensorRT-RTX rather than standard TensorRT.
...
1. `python -m pip show tensorrt-rtx-cu12`.
