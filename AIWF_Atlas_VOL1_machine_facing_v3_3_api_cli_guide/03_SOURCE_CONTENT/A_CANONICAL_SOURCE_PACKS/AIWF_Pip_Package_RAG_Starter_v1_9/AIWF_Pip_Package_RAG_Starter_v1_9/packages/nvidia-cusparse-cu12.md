...
## Identity
- **pip name:** `nvidia-cusparse-cu12`
- **import/module clue:** `nvidia.cusparse`
- **category:** `nvidia_math_lib`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
cuSPARSE sparse linear algebra package for CUDA 12-family stacks.
...
Sparse ops/package dependency; keep CUDA family aligned.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-cusparse-cu12`.
