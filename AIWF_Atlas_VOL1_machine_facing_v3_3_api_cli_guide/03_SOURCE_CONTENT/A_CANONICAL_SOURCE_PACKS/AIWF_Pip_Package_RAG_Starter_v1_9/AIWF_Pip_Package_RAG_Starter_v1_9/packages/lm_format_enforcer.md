...
## Identity
- **pip name:** `lm-format-enforcer`
- **import/module clue:** `lmformatenforcer`
...
## What it is
Token-filtering library for enforcing JSON/regex-like output formats during generation.
...
```powershell
python -m pip show lm-format-enforcer
python - <<'PY'
import importlib
mod = 'lmformatenforcer'
try:
...
## Sources
https://pypi.org/project/lm-format-enforcer/ | https://docs.vllm.ai/en/latest/features/structured_outputs/
