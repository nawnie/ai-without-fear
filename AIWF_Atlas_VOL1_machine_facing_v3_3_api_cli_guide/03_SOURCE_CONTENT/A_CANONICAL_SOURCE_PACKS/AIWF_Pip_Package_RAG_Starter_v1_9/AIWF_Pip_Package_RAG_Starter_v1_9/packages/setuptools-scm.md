...
## RAG purpose
Build-time version resolver that derives package versions from Git metadata; common source build failure point when archives lack .git metadata.
...
- pip package: `setuptools-scm`
- import/module: `setuptools_scm`

## Install / pinning notes
If a source archive reports version 0+unknown or fails version discovery, check setuptools-scm and Git metadata.
...
```
```powershell
python -c "import importlib; importlib.import_module('setuptools_scm'); print('OK: setuptools_scm')"
```
