...
## What it is
CUDA 12-family TensorRT lean runtime package.
...
Runtime-only/lean family. Do not expect the same developer/parser/build features as a full TensorRT install.
...
1. `python -m pip show tensorrt-lean-cu12`.
