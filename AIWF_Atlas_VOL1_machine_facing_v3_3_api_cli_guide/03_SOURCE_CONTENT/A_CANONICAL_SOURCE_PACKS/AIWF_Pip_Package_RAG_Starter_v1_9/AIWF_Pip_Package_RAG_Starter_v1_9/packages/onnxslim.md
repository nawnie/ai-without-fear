...
## Identity
- **pip name:** `onnxslim`
- **import/module clue:** `onnxslim`
- **category:** `onnx_graph_simplification`
- **AIWF confidence:** source-reviewed for TensorRT/NVIDIA inference stack placement and support-risk classification.

## What it is
ONNX graph slimming/simplification package often used to reduce operators and improve inference/export compatibility.
...
Do not blindly simplify production models. Keep original ONNX, simplified ONNX, validation output, opset, and numerical comparison records.
