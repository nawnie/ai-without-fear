...
## Identity
- **pip name:** `gptqmodel`
- **import/module clue:** `gptqmodel`
- **category:** `llm_quantization_toolkit`
- **AIWF confidence:** source-reviewed for v1.6 LLM serving and OpenAI-compatible local server support.

## What it is
GPTQ/AWQ and related model quantization toolkit with vLLM integration; often build-isolation/native-kernel sensitive.
...
## Sources
https://docs.vllm.ai/en/latest/features/quantization/gptqmodel/ | https://github.com/ModelCloud/GPTQModel
