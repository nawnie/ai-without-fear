...
## Identity
- **pip name:** `onnx-graphsurgeon`
- **import/module clue:** `onnx_graphsurgeon`
- **category:** `onnx_graph_rewriting`
- **AIWF confidence:** source-reviewed for TensorRT/NVIDIA inference stack placement and support-risk classification.

## What it is
NVIDIA ONNX graph editing tool used to create, inspect, and modify ONNX models before TensorRT optimization.
...
Use when exported ONNX graphs need surgery: unsupported ops, shape constants, plugin prep, graph cleanup, or replacing patterns TensorRT cannot parse.
...
1. `python -m pip show onnx-graphsurgeon`.
...
## Sources
https://docs.nvidia.com/deeplearning/tensorrt/latest/api/onnx-graphsurgeon-api.html | https://pypi.nvidia.com/
