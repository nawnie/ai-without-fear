...
## What it is
Legacy/common GPTQ quantization toolkit; still appears in model docs and older custom workflows.
...
## Sources
https://docs.vllm.ai/en/latest/features/quantization/ | https://github.com/AutoGPTQ/AutoGPTQ
