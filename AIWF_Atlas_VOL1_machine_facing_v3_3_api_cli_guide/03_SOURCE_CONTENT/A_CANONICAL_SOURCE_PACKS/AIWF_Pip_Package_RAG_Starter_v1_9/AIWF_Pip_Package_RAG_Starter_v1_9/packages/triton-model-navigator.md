...
## Identity
- **pip name:** `triton-model-navigator`
- **import/module clue:** `model_navigator`
- **category:** `triton_model_optimization_deployment`
- **AIWF confidence:** source-reviewed for Triton serving/deployment support placement.

## What it is
NVIDIA model deployment toolkit that explores export/conversion paths and helps prepare optimized formats and Triton deployment artifacts.
...
Use extras intentionally such as [torch] or [tensorflow] and the NVIDIA package index when needed. Validate resulting artifacts independently before deployment.
...
1. `python -m pip show triton-model-navigator`.
2. Verify import/module where applicable: `model_navigator`.
...
## Sources
https://docs.nvidia.com/deeplearning/triton-inference-server/user-guide/docs/model_navigator/README.html | https://pypi.org/project/triton-model-navigator/
