...
## Identity
- **pip name:** `nvidia-modelopt`
- **import/module clue:** `modelopt`
- **category:** `nvidia_model_optimization`
- **AIWF confidence:** source-reviewed for TensorRT/NVIDIA inference stack placement and support-risk classification.

## What it is
NVIDIA model optimization tooling family for quantization/compression/export-adjacent workflows feeding optimized inference stacks.
...
Advanced package. Use only when a workflow explicitly needs NVIDIA model optimization; verify torch/CUDA/TensorRT compatibility before placing in shared environments.
...
1. `python -m pip show nvidia-modelopt`.
...
## Sources
https://pypi.nvidia.com/ | https://developer.nvidia.com/tensorrt
