...
## Identity
- **pip name:** `nvidia-cuda-sanitizer-api-cu12`
- **import/module clue:** `nvidia.cuda_sanitizer_api`
- **category:** `nvidia_diagnostics`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
Compute Sanitizer API component for CUDA 12-family stacks.
...
Advanced debugging; not normally needed for end-user ComfyUI installs.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-cuda-sanitizer-api-cu12`.
