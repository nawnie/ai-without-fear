# tensorrt-rtx-cu12-libs

## Identity
- **pip name:** `tensorrt-rtx-cu12-libs`
...
## What it is
CUDA 12-family TensorRT-RTX shared/runtime libraries.
...
Library package for TensorRT-RTX; validate DLL/shared-library loading and runtime engine execution.
...
1. `python -m pip show tensorrt-rtx-cu12-libs`.
