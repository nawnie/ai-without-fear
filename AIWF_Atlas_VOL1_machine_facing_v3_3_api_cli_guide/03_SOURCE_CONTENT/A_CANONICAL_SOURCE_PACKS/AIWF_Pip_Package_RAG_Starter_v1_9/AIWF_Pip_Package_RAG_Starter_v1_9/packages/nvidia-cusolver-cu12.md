...
## Identity
- **pip name:** `nvidia-cusolver-cu12`
- **import/module clue:** `nvidia.cusolver`
- **category:** `nvidia_math_lib`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
cuSOLVER dense/sparse solver library package for CUDA 12-family stacks.
...
Usually transitive; diagnose by DLL/provider logs rather than direct import alone.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-cusolver-cu12`.
