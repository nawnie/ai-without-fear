...
## What it is
Structured output library for constrained generation across local and API LLMs; older/alternate vLLM guided decoding backend.
...
## Sources
https://dottxt-ai.github.io/outlines/latest/ | https://docs.vllm.ai/en/latest/features/structured_outputs/ | https://huggingface.co/docs/text-generation-inference/index
