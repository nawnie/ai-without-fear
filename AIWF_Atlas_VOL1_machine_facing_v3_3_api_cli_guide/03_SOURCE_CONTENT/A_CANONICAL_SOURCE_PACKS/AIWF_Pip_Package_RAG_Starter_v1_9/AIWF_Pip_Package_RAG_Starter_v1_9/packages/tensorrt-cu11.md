...
## What it is
CUDA 11-family TensorRT metapackage used when an environment is locked to CUDA 11-era compatibility.
...
Use only when the target TensorRT release and framework stack explicitly require CUDA 11-family TensorRT. Prefer current CUDA family packages for new builds.
...
1. `python -m pip show tensorrt-cu11`.
...
## Sources
https://pypi.org/project/tensorrt-cu11/ | https://docs.nvidia.com/deeplearning/tensorrt/latest/installing-tensorrt/installing.html | https://docs.nvidia.com/deeplearning/tensorrt/latest/getting-started/support-matrix.html | https://pypi.nvidia.com/ | https://pypi.org/project/tensorrt/
