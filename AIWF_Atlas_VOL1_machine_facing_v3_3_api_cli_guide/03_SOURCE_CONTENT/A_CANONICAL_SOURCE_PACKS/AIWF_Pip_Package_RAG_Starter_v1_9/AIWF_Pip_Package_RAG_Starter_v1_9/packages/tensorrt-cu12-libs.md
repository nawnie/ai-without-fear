...
## What it is
CUDA 12-family TensorRT runtime libraries.
...
A support system should record exact library package version, CUDA family, Python tag, and whether DLLs can be discovered from the active environment.
...
1. `python -m pip show tensorrt-cu12-libs`.
...
## Sources
https://pypi.nvidia.com/ | https://pypi.org/project/tensorrt-cu12/
