...
## Identity
- **pip name:** `nvidia-cublas-cu12`
- **import/module clue:** `nvidia.cublas`
- **category:** `nvidia_math_lib`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
cuBLAS dense linear algebra runtime package for CUDA 12-family Python stacks.
...
Critical ML runtime dependency; version skew can show up as DLL load failures or provider initialization failures.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-cublas-cu12`.
