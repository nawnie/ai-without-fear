...
## What it is
Optional FlashInfer package/channel family for prebuilt JIT caches matching specific CUDA versions.
...
```powershell
python -m pip show flashinfer-jit-cache
python - <<'PY'
import importlib
mod = 'flashinfer'
try:
