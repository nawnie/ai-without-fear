...
## Identity
- **pip name:** `h11`
- **import/module clue:** `h11`
- **category:** `python_http_protocol_core`
- **AIWF confidence:** source-reviewed for v1.6 LLM serving and OpenAI-compatible local server support.

## What it is
Pure-Python HTTP/1.1 protocol library used under ASGI/http stacks; useful for diagnosing protocol-layer dependency resolution.
...
## Sources
https://h11.readthedocs.io/ | https://pypi.org/project/h11/
