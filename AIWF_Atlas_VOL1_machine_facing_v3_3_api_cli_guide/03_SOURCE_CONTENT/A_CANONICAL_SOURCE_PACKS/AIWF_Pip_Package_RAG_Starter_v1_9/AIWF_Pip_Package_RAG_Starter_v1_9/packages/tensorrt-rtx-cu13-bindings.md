...
## Identity
- **pip name:** `tensorrt-rtx-cu13-bindings`
...
## What it is
CUDA 13-family TensorRT-RTX Python bindings.
...
Newest RTX bindings. Treat as cutting-edge; record exact version and index source in support bundles.
...
1. `python -m pip show tensorrt-rtx-cu13-bindings`.
