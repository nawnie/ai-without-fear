...
## Identity
- **pip name:** `torchao`
- **import/module clue:** `torchao`
- **category:** `pytorch_quantization_optimization`
- **AIWF confidence:** source-reviewed for v1.6 LLM serving and OpenAI-compatible local server support.

## What it is
PyTorch-native quantization/optimization package referenced by modern LLM quantization support paths.
...
## Sources
https://docs.vllm.ai/en/latest/features/quantization/ | https://github.com/pytorch/ao
