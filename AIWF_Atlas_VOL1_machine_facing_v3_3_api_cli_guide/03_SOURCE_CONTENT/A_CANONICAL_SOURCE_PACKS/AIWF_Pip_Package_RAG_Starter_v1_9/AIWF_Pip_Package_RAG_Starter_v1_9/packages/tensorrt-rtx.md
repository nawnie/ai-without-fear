...
## Identity
- **pip name:** `tensorrt-rtx`
- **import/module clue:** `tensorrt_rtx / TensorRT RTX runtime`
- **category:** `nvidia_tensorrt_rtx`
- **AIWF confidence:** source-reviewed for TensorRT/NVIDIA inference stack placement and support-risk classification.

## What it is
TensorRT for RTX package focused on RTX deployment and JIT-oriented runtime workflows.
...
NVIDIA documents PyPI install for Python bindings and shared library. Keep separate from standard TensorRT because support expectations and artifacts differ.
...
1. `python -m pip show tensorrt-rtx`.
...
## Sources
https://docs.nvidia.com/deeplearning/tensorrt-rtx/latest/installing-tensorrt-rtx/installing.html | https://pypi.nvidia.com/
