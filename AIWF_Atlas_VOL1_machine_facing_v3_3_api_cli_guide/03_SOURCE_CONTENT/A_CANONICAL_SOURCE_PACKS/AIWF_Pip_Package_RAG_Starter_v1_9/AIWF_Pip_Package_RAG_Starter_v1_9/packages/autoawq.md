...
## What it is
AWQ 4-bit quantization toolkit and legacy/common dependency for AWQ model preparation/inference paths.
...
## Sources
https://docs.vllm.ai/en/latest/quantization/auto_awq.html | https://github.com/casper-hansen/AutoAWQ
