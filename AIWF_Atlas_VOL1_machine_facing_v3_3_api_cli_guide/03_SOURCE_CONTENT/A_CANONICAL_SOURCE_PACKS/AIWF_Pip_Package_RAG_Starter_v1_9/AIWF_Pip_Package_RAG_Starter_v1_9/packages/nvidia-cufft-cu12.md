...
## Identity
- **pip name:** `nvidia-cufft-cu12`
- **import/module clue:** `nvidia.cufft`
- **category:** `nvidia_math_lib`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
cuFFT Fourier transform library package for CUDA 12-family stacks.
...
Usually transitive; include in manifest when building reproducible CUDA wheelhouses.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-cufft-cu12`.
