...
## Identity
- **pip name:** `nvidia-nvjpeg-cu12`
- **import/module clue:** `nvidia.nvjpeg`
- **category:** `nvidia_image_video_lib`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
NVIDIA JPEG decode/encode acceleration package for CUDA 12-family stacks.
...
Relevant for data loading/media pipelines; not a generic image package replacement.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-nvjpeg-cu12`.
