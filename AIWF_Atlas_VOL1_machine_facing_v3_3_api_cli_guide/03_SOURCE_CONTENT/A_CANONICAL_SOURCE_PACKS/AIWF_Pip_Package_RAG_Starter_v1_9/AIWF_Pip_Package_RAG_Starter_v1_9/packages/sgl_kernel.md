...
## Identity
- **pip name:** `sgl-kernel`
- **import/module clue:** `sgl_kernel`
- **category:** `llm_serving_cuda_kernel_package`
- **AIWF confidence:** source-reviewed for v1.6 LLM serving and OpenAI-compatible local server support.

## What it is
SGLang kernel/helper package area; support should treat it as backend-native acceleration rather than generic Python glue.
...
## Sources
https://docs.sglang.io/ | https://pypi.org/project/sgl-kernel/
