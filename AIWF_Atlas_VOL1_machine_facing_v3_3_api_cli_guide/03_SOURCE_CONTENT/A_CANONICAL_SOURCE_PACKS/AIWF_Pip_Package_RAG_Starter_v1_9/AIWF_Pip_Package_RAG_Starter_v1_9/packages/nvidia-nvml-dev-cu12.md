...
## Identity
- **pip name:** `nvidia-nvml-dev-cu12`
- **import/module clue:** `nvidia.nvml`
- **category:** `nvidia_management`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
NVML development package for querying NVIDIA GPU state/management from CUDA 12-family stacks.
...
Useful for telemetry/tooling; most user checks still use nvidia-smi or pynvml/nvidia-ml-py.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-nvml-dev-cu12`.
