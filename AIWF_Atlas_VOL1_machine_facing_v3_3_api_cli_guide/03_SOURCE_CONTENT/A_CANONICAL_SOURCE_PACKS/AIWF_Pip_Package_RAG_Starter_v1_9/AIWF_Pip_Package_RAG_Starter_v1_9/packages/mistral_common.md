...
## Identity
- **pip name:** `mistral-common`
- **import/module clue:** `mistral_common`
- **category:** `model_family_tokenization_chat_templates`
- **AIWF confidence:** source-reviewed for v1.6 LLM serving and OpenAI-compatible local server support.

## What it is
Mistral model-family helper package for tokenization, message templates, and model-specific request formatting.
...
## Sources
https://github.com/mistralai/mistral-common | https://pypi.org/project/mistral-common/
