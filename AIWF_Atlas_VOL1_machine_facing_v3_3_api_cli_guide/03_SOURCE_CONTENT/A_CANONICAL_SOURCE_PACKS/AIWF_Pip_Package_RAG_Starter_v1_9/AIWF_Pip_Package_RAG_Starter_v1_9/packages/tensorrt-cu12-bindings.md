...
## Identity
- **pip name:** `tensorrt-cu12-bindings`
...
## What it is
CUDA 12-family TensorRT Python bindings package.
...
Bindings alone do not prove all TensorRT runtime libraries are present. Pair with matching libs and support-matrix checks.
...
1. `python -m pip show tensorrt-cu12-bindings`.
...
## Sources
https://pypi.org/project/tensorrt-cu12-bindings/ | https://pypi.nvidia.com/
