...
## Identity
- **pip name:** `tensorrt-cu13`
- **import/module clue:** `tensorrt`
- **category:** `nvidia_tensorrt_cuda_family_metapackage`
- **AIWF confidence:** source-reviewed for TensorRT/NVIDIA inference stack placement and support-risk classification.

## What it is
CUDA 13-family TensorRT metapackage for the newest NVIDIA inference stack.
...
Cutting-edge option. Must be checked against current driver, CUDA 13 component wheel availability, Python wheel tags, and TensorRT support matrix. High risk of installer/index edge cases.
...
1. `python -m pip show tensorrt-cu13`.
...
## Sources
https://pypi.org/project/tensorrt-cu13/ | https://pypi.nvidia.com/tensorrt-cu13/ | https://docs.nvidia.com/deeplearning/tensorrt/latest/installing-tensorrt/installing.html | https://docs.nvidia.com/deeplearning/tensorrt/latest/getting-started/support-matrix.html | https://pypi.nvidia.com/ | https://pypi.org/project/tensorrt/
