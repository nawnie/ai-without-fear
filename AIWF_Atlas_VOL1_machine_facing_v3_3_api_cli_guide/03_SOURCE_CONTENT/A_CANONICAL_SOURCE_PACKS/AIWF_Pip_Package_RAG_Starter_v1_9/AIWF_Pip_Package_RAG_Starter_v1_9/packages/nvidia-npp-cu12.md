...
## Identity
- **pip name:** `nvidia-npp-cu12`
- **import/module clue:** `nvidia.npp`
- **category:** `nvidia_image_video_lib`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
NVIDIA Performance Primitives package; image/video/signal processing primitives for CUDA 12-family stacks.
...
Relevant to media/image native pipelines; usually not a direct ComfyUI dependency unless a package requests it.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-npp-cu12`.
