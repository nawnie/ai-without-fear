...
## Identity
- **pip name:** `flash-attn`
- **import/module clue:** `flash_attn`
- **category:** `attention_cuda_extension`
- **AIWF confidence:** source-reviewed for v1.6 LLM serving and OpenAI-compatible local server support.

## What it is
FlashAttention CUDA extension family used by many LLM stacks; often a source-build/native-wheel pain point.
...
## Sources
https://github.com/Dao-AILab/flash-attention | https://docs.vllm.ai/en/stable/getting_started/installation/gpu/
