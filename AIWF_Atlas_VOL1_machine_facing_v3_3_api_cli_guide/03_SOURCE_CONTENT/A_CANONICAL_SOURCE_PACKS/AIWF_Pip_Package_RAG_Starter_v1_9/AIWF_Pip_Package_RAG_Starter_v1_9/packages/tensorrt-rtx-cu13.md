...
## Identity
- **pip name:** `tensorrt-rtx-cu13`
- **import/module clue:** `TensorRT RTX runtime`
...
## What it is
CUDA 13-family TensorRT-RTX package.
...
Newest TensorRT-RTX CUDA family. Verify Python/platform wheel availability and avoid mixing with standard TensorRT packages accidentally.
...
1. `python -m pip show tensorrt-rtx-cu13`.
