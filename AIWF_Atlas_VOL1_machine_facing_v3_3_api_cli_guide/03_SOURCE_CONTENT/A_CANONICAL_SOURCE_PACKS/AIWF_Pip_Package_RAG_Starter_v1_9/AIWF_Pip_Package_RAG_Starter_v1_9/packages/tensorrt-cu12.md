...
## What it is
CUDA 12-family TensorRT metapackage; common target for modern local inference stacks tied to CUDA 12 runtime/component wheels.
...
Verify TensorRT version, Python wheel tag, driver, cuDNN compatibility, and ONNX parser compatibility before using in ComfyUI or local inference tooling.
...
1. `python -m pip show tensorrt-cu12`.
...
## Sources
https://pypi.org/project/tensorrt-cu12/ | https://docs.nvidia.com/deeplearning/tensorrt/latest/installing-tensorrt/installing.html | https://docs.nvidia.com/deeplearning/tensorrt/latest/getting-started/support-matrix.html | https://pypi.nvidia.com/ | https://pypi.org/project/tensorrt/
