...
## Identity
- **pip name:** `nvidia-cuda-cccl-cu12`
- **import/module clue:** `nvidia.cccl`
- **category:** `nvidia_cuda_headers_templates`
- **AIWF confidence:** source-reviewed for role and install-risk classification.

## What it is
CUDA C++ Core Libraries package: Thrust/CUB/libcu++ style headers for CUDA 12-family stacks.
...
Header/template component; relevant to source builds and CUDA C++ compilation.
...
1. Confirm the package is actually installed in the active venv: `python -m pip show nvidia-cuda-cccl-cu12`.
