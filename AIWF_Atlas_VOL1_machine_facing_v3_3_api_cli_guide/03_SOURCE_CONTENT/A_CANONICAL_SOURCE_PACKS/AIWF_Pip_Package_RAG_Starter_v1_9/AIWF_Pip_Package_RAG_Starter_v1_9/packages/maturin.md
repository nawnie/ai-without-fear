...
## RAG purpose
Rust/PyO3 wheel builder; relevant because modern tokenizer/vector/database packages increasingly ship Rust native code.
...
- pip package: `maturin`
- import/module: `maturin`

## Install / pinning notes
Needs Rust toolchain if building from source; prefer prebuilt wheels unless developing/patching.
...
```
```powershell
python -c "import importlib; importlib.import_module('maturin'); print('OK: maturin')"
```
