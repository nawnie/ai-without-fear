...
- JSONL/Markdown export standards
...
## Runtime Package Ledger Update — 2026-05-19

The RAG Source Ledger lane now has a concrete runtime/package pass. Route package, dependency, one-click installer, and venv-island notes to:

```text
rag/02_python_pip_and_runtime_packages/
```

Current build-worthy gaps:

- requirements auditor before custom node install
- workflow dependency report for JSON workflows
- profile runner for Gradio shell + isolated backend venvs
- EnvPack checks for torch/CUDA/ONNX/OpenCV conflicts

## 14 — ML Theory / Training RAG Chat

Owns:

- ML theory source ledger
- beginner-safe concept cards
- training ladder
- Volume I vs Volume II boundary notes
- retrieval exports for diffusion, latent space, tokens, attention, LoRA, PEFT, ControlNet, and newer backbones

Does not own:

- final book prose unless routed to Field Manual
- workflow JSON implementation
- runtime/package install maps
- agent tool-use implementation
...
## v0.6 Chat Map Addition

### 15 — CFG / Denoise / Inpaint Theory

Purpose: maintain the operator-theory bridge between ML concepts and practical image-editing workflows.
...
- Workflow Packs for JSON implementation
- ComfyUI Nodes for validator/tooltips
- EnvPack for workflow diagnostic checks
- Field Manual for beginner-facing explanations
...
### Unique retained material from `CONTENT/AIWF-Project-Chat-Distribution-Roadmap-v0.5-comfyui-core-api-subgraph/AIWF-Project-Chat-Distribution-Roadmap/PROJECT_CHAT_MAP.md`

## 14 — ComfyUI Core/API Schema Chat
- live `/object_info` capture strategy
...
- general node-pack review
- Field Manual prose editing
Primary integration targets:


### Unique retained material from `CONTENT/AIWF-Project-Chat-Distribution-Roadmap-v0.3-rag-source-ledger/AIWF-Project-Chat-Distribution-Roadmap/PROJECT_CHAT_MAP.md`

- source ledger
- RAG source-note directories
